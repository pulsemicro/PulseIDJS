module Helpers {
    export interface IRenderer {
        ...
        letteringBase64String: (options: Options.LetteringOptions, callbackSuccess: (base64string: string) => void, callbackFail: (errorMessage: string) => void) => void;
        letteringTextFontColorBase64String: (text: string, font: string,colors: string[], callbackSuccess: (base64string: string) => void, callbackFail: (errorMessage: string) => void) => void;
        template: (templateFile, imageId, callbackSuccess, personalizations?: Options.Peronalization[]) => void;
        templateBase64String: (templateFile, callbackSuccess: (data) => void, callbackFail: (errorMessage: string) => void, personalizations?: Options.Peronalization[]) => void;
        ...
        designBase64String: (fileName: string, palette: string[], needles: number[], transformationOptions: Options.TransformationOptions, callbackSuccess: (url) => void, callbackFail: (errorMessage: string) => void) => void;
    }
